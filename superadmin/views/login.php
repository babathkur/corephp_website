...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="public/"
        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                ...
                <div class="card">
                    ...
                    <div class="mb-3">
                        <input class="btn btn-primary d-grid w-100" type="submit" value="Submit" name="submit">
                    </div>
                    </form>
